...
public interface UserController {
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "count", description = "Number of users to generate", example = "500")
        }
    )
    @ApiResponses({
    ...
    ResponseEntity<List<UserEntity>> getRandomUsers(@RequestParam(defaultValue = "500") int count);
}
